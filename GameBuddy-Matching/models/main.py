...
async def predict(username: int):
    with open("/Users/burak/Developer/MachineLearning/GameBuddy/GameBuddy-Matching/models/games-encoded.pkl", "rb") as f:
        df_games_encoded = pickle.load(f)

    with open("/Users/burak/Developer/MachineLearning/GameBuddy/GameBuddy-Matching/models/matching.pkl", "rb") as f:
